...
{
public:
	using CategoryGetter = std::string_view (*)();

public:
	Logger(CategoryGetter category_getter, LoggerCallbackRef callback_ref) noexcept
	...
	{
		callback_ref.get()(LogMessage{category_getter(),
		                              level,
...
private:
	CategoryGetter category_getter;
